...
async function reagendarProcessamento(empresaId, empresaSlug, instanciaEvolution, chamadoId, telefone, segundosDebounce) {
  ...
  await filaDebounce.add(
    id,
    { empresaId, empresaSlug, instanciaEvolution, chamadoId, telefone },
    {
      jobId: id,
